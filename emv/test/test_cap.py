...
class TestCAP(TestCase):
    ...
    def test_arqc_req_payment(self):
        ...
        req = get_arqc_req(
            TLV.unmarshal(APP_DATA)[0x70], value=1234.56, challenge=78901234
        )
        data = unformat_bytes(
        ...
        req = get_arqc_req(
            TLV.unmarshal(APP_DATA)[0x70], value=15.00, challenge=78901234
        )
        data = unformat_bytes(
    ...
    def test_real_response_rmtf1(self):
        ...
        self.assertEqual(get_cap_value(res, ipb=BARCLAYS_IPB, psn=None), 46076570)

    def test_real_response_rmtf2(self):
        ...
        res = RAPDU.unmarshal(data)
        self.assertEqual(get_cap_value(res, ipb=BARCLAYS_IPB, psn=None), 36554800)
